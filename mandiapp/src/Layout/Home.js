...
import img3 from '../Img/smart-farming.png';
                        ...
                        <div className="col-lg-7">
                            <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel">
                                <div className="carousel-inner">
                                    ...
                                    <div className="carousel-item">
                                        <img src={img3} className="d-block img-fluid" alt="..." style={{ width: '60rem', height:'30rem' }} />
                                    </div>
                                </div>
                            ...
                            <div className="card" style={{ width: "18rem" }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="btn-box">
                                        <a href="#" className="btn btn-danger">Animals</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='col-lg-4 col-md-4 col-12 d-flex justify-content-center'>
                            <div className="card" style={{ width: "18rem" }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <div className="btn-box">
                                        <a href="#" className="btn btn-danger">Fertilizers</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='col-lg-4 col-md-4 col-12 d-flex justify-content-center'>
                            <div className="card" style={{ width: "18rem" }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <div className="btn-box">
                                        <a href="#" className="btn btn-danger">Crops</a>
                                    </div>
                                </div>
                            </div>
                        </div>
